...
echo "`date` java -cp $JAR $MAIN -est -modelDir /data/user_category/llda/models -docDir /data/user_category/llda/docs -model elex -ntopics 3 $args >> $logFile 2>&1" >> $logFile
